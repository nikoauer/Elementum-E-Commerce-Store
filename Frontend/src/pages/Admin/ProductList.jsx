...
const ProductList = () => {
  ...
  const handleSubmitProduct = async (event) => {
    ...
    try {
      ...
      if (data.error) {
        toast.error("Your product submission failed, try again please", {
          position: "top-center",
        });
      } else {
        toast.success(`${data.name} has successfuly been created`, {
          position: "top-center",
        });
        navigate("/");
      }
        ...
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto mb-8">
            ...
            <p className="mt-2 text-sm text-gray-700">
              You can manage your products from this page. You can upload an
              image for a new product and input information about the item.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-12">
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-gray-600">
                  You can start by uploading an image of the product you wish to
                  sell.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-gray-600">
                  You can add information about the product such as name, brand,
                  description, price, qauntity, amount in stock and which
                  category of products it belongs to.
                </p>
              </div>
