          ...
          >
            <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-50 rounded-lg bg-gray-100 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
              <li>
                <a
                  href="#"
                  class="block py-2 px-3 md:p-0 text-black rounded hover:bg-blue-200 md:hover:bg-transparent md:hover:text-blue-600"
                  aria-current="page"
                >
                  Home
                </a>
              ...
              <li>
                <a
                  href="#"
                  class="block py-2 px-3 md:p-0 text-black rounded hover:bg-blue-200 md:hover:bg-transparent md:hover:text-blue-700 "
                >
                  Cart
                </a>
              </li>
